# Implementation of StochasticRFOvershotDiscreteScheduler 
# From the paper: AMO Sampler: Enhancing Text Rendering with Overshooting
...
class StochasticRFOvershotDiscreteScheduler(SchedulerMixin, ConfigMixin):
    ...
    def __init__(
        ...
        self.overshot_func = lambda t, step_size: t + step_size
    ...
    def step(
        ...
        if self.remove_noise:
            prev_sample = sample_overshoot * a
        else:
            if self.b_scale is not None:
                prev_sample = sample_overshoot * a + rand_noise * b * self.b_scale
            else: 
